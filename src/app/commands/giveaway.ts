...
export const command: CommandData = {
    ...
    default_member_permissions:
        PermissionsBitField.Flags.ManageEvents.toString(),
    options: [
        {
            name: "create",
            ...
            options: [
                ...
                },
                {
                    name: "required_role",
                    description:
                        "Role required to participate in the giveaway.",
        ...
        },
        {
            ...
            options: [
                ...
                },
                {
                    name: "count",
                    description:
                        "Number of new winners to select (default: 1).",
                    type: ApplicationCommandOptionType.Integer,
                    required: false,
                    min_value: 1,
                    max_value: 10,
            ...
            options: [
                {
                    name: "status",
                    description:
                        "Filter giveaways by status (default: active).",
                    type: ApplicationCommandOptionType.String,
                    required: false,
                    choices: [
...
async function handleCreateGiveaway(
    ...
    try {
        ...
        const durationMinutes =
            interaction.options.getInteger("duration") || 1440;
...
async function handleListGiveaways(
    ...
    try {
        ...
        const embed = new EmbedBuilder()
            .setTitle(
                `${status.charAt(0).toUpperCase() + status.slice(1)} Giveaways`
            )
            .setColor("Red")
            .setDescription(
                giveawaysToShow
