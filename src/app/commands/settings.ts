                    ...
                    options: [
                        {
                            ...
                            choices: [
                                ...
                                {
                                    name: "Toggle Auto-Claim On Message",
                                    value: "auto_claim",
                                },
                                {
                                    name: "Toggle One Claimer Only",
                                    value: "one_claimer",
                                },
                            ],
                        },
                ...
                },
                {
                    ...
                    options: [
                        ...
                        },
                        {
                            name: "value",
                            description:
                                "Value for the setting (if applicable)",
    ...
    switch (subcommand) {
        ...
        case "claims": {
            ...
            switch (action) {
                ...
                case "one_claimer":
                    settings.claims.onlyOneClaimer =
                        !settings.claims.onlyOneClaimer;
                    await settings.save();
                    return interaction.reply({
        ...
        case "banlist": {
            ...
            if (action === "view") {
                ...
                if (banList.length === 0) {
                    return interaction.reply({
                        content:
                            "No users are currently banned from creating tickets.",
                        flags: [MessageFlags.Ephemeral],
                    });
                }
        ...
        case "view": {
            ...
            const averageResponseTime =
                settings.stats?.averageResponseTime || 0;

            let formattedResponseTime = "N/A";
            if (averageResponseTime > 0) {
                if (averageResponseTime < 1000) {
                    formattedResponseTime = `${Math.round(
                        averageResponseTime
                    )}ms`;
                ...
                .addFields(
                    { name: "Access", value: settings.access, inline: true },
                    {
                        ...
                        value: `Enabled: ${
                            ...
                            settings.claims?.onlyOneClaimer ? "Yes" : "No"
                        }`,
                        inline: true,
                    },
                    {
                        ...
                        value: `Enabled: ${
                            ...
                            settings.autoClose?.interval
                                ? `${Math.round(
                                      settings.autoClose.interval / 60
                                  )} min`
                                : "N/A"
                        }`,
                        inline: true,
                    ...
                    },
                    {
                        name: "Ban List",
                        value: `${
                            settings.ticketBanList?.length || 0
                        } user(s) banned`,
                        inline: true,
                    }
                );
